package com.triplea.triplea.core.advice;
...
public class MyLogAdvice {
    ...
    @Pointcut("@annotation(com.triplea.triplea.core.annotation.MyLog)")
    public void myLog(){}

    @Pointcut("@annotation(com.triplea.triplea.core.annotation.MyErrorLog)")
