...
//                    chart.setBuzz(buzzData.getCount()); // buzz 설정
    ...
    @Transactional(readOnly = true)
    public StockResponse.StockInfoDTO getChartAndBuzz(String symbol, String startDate, String endDate, String resampleFreq, User user){
        ...
        StockResponse.StockInfoDTO stockInfoDTO = new StockResponse.StockInfoDTO(membership.toString(), symbol, companyName, charts);
        stockInfoDTO.setBuzzDataList(globalBuzzDuration.getBuzzDatas());
